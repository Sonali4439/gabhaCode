...
class ActivityCardWithImage extends StatefulWidget {
  const ActivityCardWithImage({Key? key}) : super(key: key);

  @override
  State<ActivityCardWithImage> createState() => _ActivityCardWithImageState();
}

class _ActivityCardWithImageState extends State<ActivityCardWithImage> {
                              ...
                              Expanded(
                                child: Column(
                                  children: [
                                    ...
                                    Padding(
                                      padding: const EdgeInsets.only(top: 60),
                                      child: Image.asset("assets/images/color_img.png",width: 150,height: 150,),
                                    ),
